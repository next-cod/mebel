...
const disclaimerText =
  "Это не настоящий сайт. Это демонстрационный пример – учебный кейс, сделанный для портфолио, чтобы показать дизайн и вёрстку. Компания «Heritage Wood» вымышлена: все названия, имена, контакты, цифры, кейсы и отзывы выдуманы исключительно для показа оформления, любые совпадения с реальными людьми и организациями случайны. Сайт не оказывает услуг, не принимает заявок и не собирает персональные данные, не является публичной офертой или рекламой.";
        ...
        <div className="mt-16 border-t border-cream/10 pt-8">
          ...
          <div
            ...
            className={`overflow-hidden transition-[max-height,opacity] duration-300 ease-out ${
              showDisclaimer ? "mt-5 max-h-56 opacity-100" : "max-h-0 opacity-0"
            }`}
          >
